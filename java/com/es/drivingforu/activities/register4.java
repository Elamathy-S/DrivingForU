...
public class register4 extends AppCompatActivity {
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        if(EditTextEmptyHolder == true)
        {
            ...
            SQLiteDataBaseQueryHolder = "INSERT INTO "+SQLiteHelper.TABLE_NAME+" (name,email,password,number,address) VALUES('"+NameHolder+"', '"+EmailHolder+"', '"+PasswordHolder+"', '"+NumberHolder+"', '"+AddressHolder+"');";
            ...
            Toast.makeText(register4.this,"Driver Registered Successfully", Toast.LENGTH_LONG).show();
        ...
        // This block will execute if any of the registration EditText is empty.
            ...
            Toast.makeText(register4.this,"Please Fill All The Required Fields.", Toast.LENGTH_LONG).show();
    ...
    public void CheckFinalResult(){
        ...
        if(F_Result.equalsIgnoreCase("Email Found"))
        {
            ...
            Toast.makeText(register4.this,"Email Already Exists",Toast.LENGTH_LONG).show();
